...
public class ImageBase64 {
     ...
     */
    public String encodeFile(Uri filePath) throws FileNotFoundException {

        Bitmap bitmap = null;
        if(noScale){
            bitmap = decodeFile(filePath.toString());
        }
        else{
            bitmap = decodeSampledBitmapFromFile(filePath.toString(), width, height);
        }
